...
= 1.8.1 2026-07-28 =
* Fix Bugs
* Integracão com WCFM para marketplaces como Extensão
* Agora alguns erros aparecem como alerta na dashbaord
* Melhorias na etiqueta
* Melhorias na customização da calculadora, com mais cores e personalizações
...
* Etiqueta Internacional unitizadora cn35
* Fatura de Entrega Internacional cn38
...
= 1.6.25 2025-08-06 =
* Melhoria no Editor e Customizador da Calculadora
* Impressão de etiquetas melhorada
* Outras correções

= 1.6.15 2025-07-15 =
* Correção do texto de prazo dos fretes do melhor envio
* Correção da customização de calculadora na página do produto
* 100% de Compatibilidade com a nova versão do WooCommerce
