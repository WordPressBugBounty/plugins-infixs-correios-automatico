...
$icon_color = infixs_get_icon_color_attribute( $calculator_styles );
?>
<div style="clear: both;"></div>
<div class="infixs-correios-automatico-calculator">
	<div class="infixs-correios-automatico-calculator-title" <?php echo infixs_get_inline_style_attribute( 'title', $calculator_styles ); ?>>
		Calcular o Frete
	</div>
	<div class="infixs-correios-automatico-calculate-box">
		<div class="infixs-correios-automatico-input-text">
			<div class="infixs-correios-automatico-input-text-prepend">
				<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 20 20" <?php echo $icon_color; ?>>
			...
			<input type="text" id="infixs-correios-automatico-input-postcode"
				...
				maxlength="9" placeholder="Digite seu CEP" <?php echo infixs_get_inline_style_attribute( 'input', $calculator_styles ); ?>>
		...
		<?php if ( ! Config::boolean( 'general.auto_calculate_product_shipping_postcode' ) ) : ?>
			<div class="infixs-correios-automatico-postcode-button-box">
				<a name="infixs-correios-automatico-postcode" type="submit"
					class="button alt wp-element-button infixs-correios-automatico-calculate-submit" <?php echo infixs_get_inline_style_attribute( 'button', $calculator_styles, [], [ 'display: flex;' ] ); ?>>
					Calcular
				</a>
			</div>
		<?php endif; ?>
	...
	<div>
		<a class="infixs-correios-automatico-calculate-find-link" target="_blank"
			href="https://buscacepinter.correios.com.br/app/endereco/index.php" <?php echo infixs_get_inline_style_attribute( 'find_postcode', $calculator_styles ); ?>>
			Não sei meu CEP
		</a>
	</div>
...
<style id="infixs-correios-automatico-calculator-responsive-styles">
	...
	@media (max-width: 768px) {
		...
		<?php if ( isset( $calculator_styles['input'] ) ) : ?>
		...
		<?php if ( isset( $calculator_styles['button'] ) ) : ?>
